...
mod macro_tests {
    ...
    fn many_arguments() {
        let result = alt!(
            None::<i32>, None, None, None, None, 
            None, None, Some(777), Some(888)
        );
    ...
    #[test]
    fn function_calls() {
        fn get_none() -> Option<i32> { None }
        fn get_some() -> Option<i32> { Some(42) }
    ...
    #[test]
    fn fallback_chain() {
        fn primary() -> Option<String> { None }
        fn secondary() -> Option<String> { None }
        fn tertiary() -> Option<String> { Some("fallback".to_string()) }
